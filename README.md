...
An opinionated starter kit for a **personal knowledge base that an LLM writes and maintains for you** — built with [Claude Code](https://www.anthropic.com/claude-code) as the agent and [Obsidian](https://obsidian.md) as the reading UI, and conformant to Google's [Open Knowledge Format (OKF) v0.2](https://github.com/GoogleCloudPlatform/knowledge-catalog/blob/main/okf/SPEC.md).
